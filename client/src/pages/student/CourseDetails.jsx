...
const CourseDetails = () => {
    ...
    <>
      <div className='flex md:flex-row flex-col gap-10 relative items-start justify-between md:px-36 px-8 md:pt-30 pt-20 text-left'>
        ...
        <div className='max-w-xl z-10 text-gray-500'>
          ...
          <p className='text-sm'>Course By <span className='text-blue-600 underline'>Parth Agrawal</span></p>
  ...
  <button className='md:mt-6 mt-4 w-full py-3 rounded bg-blue-600 text-white font-medium'>{isAlraedyEnrolled ? 'Already Enrolled': 'Enroll now'}</button>
<div className='pt-6'>
